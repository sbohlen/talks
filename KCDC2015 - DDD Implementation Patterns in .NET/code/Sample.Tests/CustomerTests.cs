...
namespace Sample.Tests
{
    ...
    public class CustomerTests
    {
        ...
        public class When_Name_Is_Not_Valid_To_Change
        {
            ...
            public void _TestSetUp()
            {
                _invaldiName = new Name(VALID_FIRSTNAME, INVALID_LASTNAME);
                _customer = new Customer();
            }
            ...
            {
                Assert.Throws<NameChangeFailure>(() => _customer.ChangeName(_invaldiName));
            }
            ...
            public void Invalid_Name_Is_Available_To_Inspect()
            {
                try
                {
                    _customer.ChangeName(_invaldiName);
                }
                catch (NameChangeFailure failure)
                {
                    Assert.That(failure.AttemptedName, Is.SameAs(_invaldiName));
                }
            }

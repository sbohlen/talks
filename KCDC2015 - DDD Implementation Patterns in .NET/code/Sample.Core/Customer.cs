    ...
    public class Customer : IdentityPersistenceBase<Customer, int>
    {
        ...
        public void CancelOrder(Order order)
        {
            ...
            if (_orders.Contains(order))
            {
                 ...
                 * var orderToCancel = _orders.Single(candidate => candidate.Id == order.Id);
                 */
                var orderToCancel = _orders.Single(candidate => candidate == order);
        ...
        public void ChangeName(string firstname, string lastname)
        {
            try
            {
                ...
                _name = _name.ChangeName(firstname, lastname);
            }
            catch (NameChangeFailure)
            {
                //do something to react properly to this case
            }
        }

        public void ChangeName(Name name)
        {
            ChangeName(name.Firstname, name.Lastname);
        }
